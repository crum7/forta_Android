...
class firsttime_4 : Fragment() ,View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_firsttime_4 , container , false)
    }
    ...
    override fun onViewCreated(view: View , savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.button_first_4).setOnClickListener(this)
        //アプリの起動回数把握
    ...
    override fun onClick(v: View?) {
        when(v!!.id){
            ...
            R.id.button_first_4-> navController!!.navigate(R.id.action_firsttime_4_to_tourokuManday)
